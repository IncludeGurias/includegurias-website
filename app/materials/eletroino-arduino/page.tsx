    ...
    >
      ...
      <Flex direction={"column"} px={4} align="center">
        ...
        <Text mt={4} color={"primary.TEXT"} as={"span"} fontSize={{ base: "xl" }} maxW={{ base: "100%", md: "3xl" }}>
          Elétroino: Arduino é uma série de histórias em quadrinhos que ensina eletrônica avançada de uma maneira
          divertida e acessível, apresentando conceitos como sensores, atuadores e comunicação sem fio.
        </Text>
